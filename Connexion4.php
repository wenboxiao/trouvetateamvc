...
<html>
    ...
    <body>
        ...
        <form method="post" action="Pass.php">
                ...
                <div class="pss"><input type="text" name="tttpseudo" id="tttpseudo" class="tttpseudo" placeholder="Ex: Fred" size="30" maxlength="30" /></div><br />
                <h4 class="titrerouge">le pseudo n'existent pas'</h4>
                <label for="pass" class="titrevert2">Votre mot de passe :</label><br />
                <div class="pss"><input type="password" name="tttpass" id="tttpass" placeholder="Ex: 1234" size="30" maxlength="30"/></div><br />
