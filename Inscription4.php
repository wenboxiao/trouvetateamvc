    ...
    <body>
      <?php include("Barred.php");?>
        ...
        <form method="post" action="Insc.php" class="centrerco">
          <div class="centrerco"><div>
          <input type="text" name="Nom" id="Nom" placeholder="Nom" size="10" maxlength="30" /> 
				<input type="text" name="Prenom" id="Prenom"placeholder="Prenom" size="10" maxlength="30" /></div><br />
				<div> <input type="text" name="Pseudo" id="Pseudo" placeholder="*Pseudo" size="25" maxlength="30" />*</div><br /> 
				<div><input type="text" name="Telephone" id="Telephone"	placeholder="Téléphone" size="25" maxlength="10" /></div><br />
			...
			<div><input type="password" name="Pass" id="Pass" placeholder="*MotDePass" size="25" maxlength="70" />*</div><br />

			<div><input type="password" name="Confi" id="Confi" placeholder="*Confirmation" size="25" maxlength="70" />*</div><br />
              <h4 class="titrerouge">Il faut remplir les champs obligatoire *</h4><br />
          </div>
