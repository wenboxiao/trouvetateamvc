...
<html>
    ...
    <body>
        ...
        <p class="textebleu"> Vous devez être connecté depuis un compte possedant les droits d'administrateur ou de modérateur pour accèder à cette partie du site.
        </p>
