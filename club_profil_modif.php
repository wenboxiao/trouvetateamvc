...
<html>
 ...
 <div class="space"></div>     
        <form method="post" action="club_profil_modif_php.php" class="centrerco">
          <div class="centrerco">
          	  <label for="Nom">Nom du club :</label><input type="text" name="Nom" id="Nom"  value="<?php echo  $_POST['nom_club']; ?>" size="10" maxlength="30"  />
              <label for="Sport">Sport :</label><input type="text" name="Sport" id="Sport" value="<?php echo  $_POST['sport_club']; ?>" maxlength="30"/><br />
              <label for="Ville">Ville :</label> <input type="text" name="Ville" id="Ville" value="<?php echo  $_POST['ville_club']; ?>" size="25" /><br />
              <label for="Club">Adresse :</label> <input type="text" name="Adresse" id="Adresse" value="<?php echo $_POST['adresse_club']; ?>" size="25" /><br />
              <label for="Mail">E-mail :</label> <input type="email" name="Mail" id="Mail" value="<?php echo  $_POST['mail_club']; ?>" size="25" maxlength="70"/><br />
 <label for="description">Description :</label><textarea name="description" id="description" rows="10" cols="50"><?php echo  $_POST['description_club']; ?></textarea><br />             
          </div>
