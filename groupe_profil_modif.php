...
<html>
 ...
 <div class="space"></div>     
        <form method="post" action="groupe_profil_modif_php.php" class="centrerco">
          <div class="centrerco">
          	  <label for="Nom">Nom de la team :</label><input type="text" name="Nom" id="Nom"  value="<?php echo  htmlspecialchars($_POST['nom_team']); ?>" size="10" maxlength="30"  /><br />
              <label for="Sport">Sport :</label><input type="text" name="Sport" id="Sport" value="<?php echo htmlspecialchars($_POST['sport_team']); ?>" maxlength="30"/><br />
              <label for="Ville">Ville :</label> <input type="text" name="Ville" id="Ville" value="<?php echo htmlspecialchars($_POST['ville_team']); ?>" size="25" /><br />
              <label for="Club">Club :</label> <input type="text" name="Club" id="Club" value="<?php echo htmlspecialchars($_POST['club_team']); ?>" size="25" maxlength="70"/><br />
              <label for="description">Description :</label><textarea name="description" id="description" rows="10" cols="50"><?php echo  htmlspecialchars($_POST['description_team']); ?></textarea><br />
           </div>  
