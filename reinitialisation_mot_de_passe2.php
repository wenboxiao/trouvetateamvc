...
<html>
 ...
 <div class="space"></div>   
          ...
          <h1 class="titrebleu">Veuillez entrer votre code ci-dessous (ATTENTION: uniquement valide pendant 10 minutes) : </h1><br/> <br/>
         ...
         <label for="code">Code :</label><input type="text" name="code" id="code"  size="25" maxlength="70"/><br />
						...
						<input  name="token" type="hidden"  value="<?php echo htmlspecialchars($_POST['token'])?>" >
					    <input  name="time" type="hidden"  value="<?php echo htmlspecialchars($_POST['time'])?>" >
					    <input  name="pseudo" type="hidden"  value="<?php echo htmlspecialchars($_POST['pseudo'])?>" >
